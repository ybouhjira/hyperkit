...
sidebar_position: 2
description: The complete --sk-* design token reference.
---
...
- **Component API**: See the [component reference](../components/index.md) for prop interfaces
- **Explorer**: Browse live examples in the [component explorer](https://hyperkit-explorer.vercel.app)
- **Theme Guide**: See [Theming](../getting-started/theming.md) for color/spacing/radius tokens
- **AI Docs**: Machine-readable docs ship in the npm package as `llms.txt` and `llms-full.txt`
