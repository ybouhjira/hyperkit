...
sidebar_position: 1
description: Using HyperKit with Solid Start and other SSR frameworks.
---
...
See the [Solid Start example](https://github.com/ybouhjira/hyperkit/tree/main/examples/solid-start) for a complete working implementation.
